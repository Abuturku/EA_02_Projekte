...
public enum Configuration {
    ...
    INSTANCE;
    public final static CrossoverEnum CROSSOVER_TYPE = CrossoverEnum.TWO_POINT;
    public final static int K_FOR_CROSS_OVER = 4; //for kPoint crossover
